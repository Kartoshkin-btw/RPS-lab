 ...
 * @author utkin
 */
public class ListOfRoutes extends HttpServlet {
    @EJB
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException  {
        try {
            ...
            request.setAttribute("routes", result);
            RequestDispatcher requestDispatcher = request.getRequestDispatcher("ListOfRoutes.jsp");
